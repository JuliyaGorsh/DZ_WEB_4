...
$work = [
    ...
    [
        'job' => 'Наставник',
        'time' => 'Октябрь 2020 - Июнь 2021',
    ],
    [
       'job' => 'Специалист',
       'time' => 'Январь 2019 - Октябрь 2020',
    ],
];
?>
      ...
      <div class="w3-twothird">
        <div class="w3-container w3-card w3-white w3-margin-bottom">
          ...
          <div class="w3-container">
            ...
            <h5 class="w3-opacity"><b><?php echo $work[0]['job']; ?> </b></h5>
            <h6 class="w3-text-teal"><i class="fa fa-calendar fa-fw w3-margin-right"></i><?php echo $work[0]['time']?> <span
          ...
          <?php for ($i = 1; $i < count($work); $i++):?>
          <div class="w3-container">
            <h5 class="w3-opacity"><b><?php echo $work[$i]['job']; ?></b></h5>
            <h6 class="w3-text-teal"><i class="fa fa-calendar fa-fw w3-margin-right"></i><?php echo $work[$i]['time']?></h6>
            <p>Consectetur adipisicing elit. Praesentium magnam consectetur vel in deserunt aspernatur est reprehenderit</p>
            <hr>
          </div>
          <?php endfor;?>
